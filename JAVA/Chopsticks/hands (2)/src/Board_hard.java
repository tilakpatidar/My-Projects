 ...
 */
/*in board med 6,8,9 sec time for each move + 2 min to win */
/**
 *
 * @author tilak
 */
public class Board_hard extends javax.swing.JFrame {
    int sb1=0,sb2=0,sb3=0,sb4=0,turn=0,time; //0 for user and 1 for cpu
     Timer1 obj1=new Timer1();   //timer for player 2
      ...
      Timer3 obj3=new Timer3();  //2 mins timer for game
      Thread thread3=new Thread(obj3);
      
    /**
     * Creates new form Board_hard
     */
      public Board_hard() {
        initComponents();
        
    }
       public Board_hard(int t){
           time=t;
           initComponents();
...
public class Timer1 implements Runnable{    //timer for player 2
        ...
        public void run() {
            ...
            while(true)
            {
                 ...
                 if(Integer.parseInt(jLabel3.getText())==time)
                {
                    JOptionPane.showMessageDialog(Board_hard.this,"Time is up please try later !");
                     Game a=new Game();
                   a.disableButtons();
            ...
            while(true)
            {
                    ...
                    try {
                        ...
                        jLabel5.setText(""+(Integer.parseInt(jLabel5.getText())+1));
                          if(Integer.parseInt(jLabel5.getText())==time)
                {
                    //you lose
                    JOptionPane.showMessageDialog(Board_hard.this,"Time is up please try later !");
                    Game a=new Game();
            ...
            while(true)
            {
                    ...
                    try {
                        ...
                        jLabel7.setText(""+(Integer.parseInt(jLabel7.getText())-1));
                          if(Integer.parseInt(jLabel7.getText())==0) //2 min game
                          {    
                    //you lose
                    JOptionPane.showMessageDialog(Board_hard.this,"Time is up please try later !");
                   Game a=new Game();
        ...
        void result(int move)
        {
           ...
           if(move==120) //r
           {
              ...
              int b1=Integer.parseInt(pb1.getName());
               ...
               if(b2==0)
               {
                   int input=JOptionPane.showConfirmDialog(Board_hard.this,"Do you want to regenerate ?");
                   if(input==0)
                   {
                       if(b1%2==0)
                       {
               ...
               win(turn,move);
                       ...
                       else
                       {
                         if(turn==0)
                            {
                            JOptionPane.showMessageDialog(Board_hard.this,"Can only regenerate even fingers !");
                            status_zero();
                            }
                            else if(turn==1)
                            {
                                status_zero();
                                JOptionPane.showMessageDialog(Board_hard.this,"Invalid move !");
                            }
    ...
    void win(int c,int chutiyapa)
    {
        if(c==0)
        {
           ...
           if(a==0&&b==0)
           {
               ...
               thread1.stop();
               thread3.stop();
               JOptionPane.showMessageDialog(Board_hard.this,"Congratulations " +Board_hard.p1+" you won !!!");
              disableButtons();
           }else
           {
        ...
        else if(c==1)
        {
           ...
           if(a==0&&b==0)
           {
               ...
               thread1.stop();
               thread3.stop();
               JOptionPane.showMessageDialog(Board_hard.this,"Congratulations " +Board_hard.p2+" you won !!!");
               disableButtons();
           }
           else
           {
...
public class Cpumove extends Game{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Board_hard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Board_hard().setVisible(true);
            }
        });
    }
