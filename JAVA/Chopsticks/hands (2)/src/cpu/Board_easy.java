 ...
 */
/*in board easy 15 sec time for each move*/
/**
 *
 * @author tilak
 */
public class Board_easy extends javax.swing.JFrame {
...
Game a=new Game();
a.cb1Action();// TODO add your handling code here:
...
public class Timer1 implements Runnable{    //timer for player 2
        ...
        public void run() {
            ...
            while(true)
            {
                ...
                if(Integer.parseInt(jLabel3.getText())==15)
                {
                    //you lost
                    JOptionPane.showMessageDialog(Board_easy.this,"Time is up please try later !");
...
public class Timer2 implements Runnable{  //timer for player 1
 ...
 {
     JOptionPane.showMessageDialog(Board_easy.this,"Cannot play CPU moves!");
 }
        }
        void cb2Action()
        {
...
else if((sb3==1||sb2==1)||(sb4==1))
 {
    ...
    obj.result(a);
   // System.out.println(turn);
 // System.out.println("USER MOVE IS "+a);
 ...
 {
     JOptionPane.showMessageDialog(Board_easy.this,"It's not your turn !");
 }
 }
         void pb2Action()
 {
 ...
 else if(turn==1)
 {
        ...
        void result(int move)
        {
           ...
           if(move==120) //r
           {
              ...
              int b1=Integer.parseInt(pb1.getName());
               ...
               if(b2==0)
               {
                   int input=JOptionPane.showConfirmDialog(Board_easy.this,"Do you want to regenerate ?");
                   if(input==0)
                   {
                       if(b1%2==0)
                       {
               ...
               win(turn,move);
                       ...
                       else
                       {
                         if(turn==0)
                            {
                            JOptionPane.showMessageDialog(Board_easy.this,"Can only regenerate even fingers !");
                            status_zero();
                            }
                            else if(turn==1)
                            {
           ...
           if(result==5)
            {
               ...
               else if(allow1==0 ||allow2==0)
               {
                  if(turn==0)
                   {
                   JOptionPane.showMessageDialog(Board_easy.this,"Invalid move !");
                   status_zero();
                   }
                   else if(turn==1)
                   {
    ...
    void win(int c,int move)
    {
        if(c==0)
        {
           ...
           if(a==0&&b==0)
           {
               System.out.println("USER MOVE IS "+move);
               printStatus();
                thread2.stop();
               thread1.stop();
               JOptionPane.showMessageDialog(Board_easy.this,"Congratulations " +Board_easy.p1+" you won !!!");
              disableButtons();
           }else
           {
               System.out.println("USER MOVE IS "+move);
        ...
        else if(c==1)
        {
           ...
           if(a==0&&b==0)
           {
               ...
               System.out.println("CPU FINAL MOVE IS "+move);
           printStatus();
               thread2.stop();
               thread1.stop();
               JOptionPane.showMessageDialog(Board_easy.this,"Try again ! " +Board_easy.p2+" beats you !!!");
               disableButtons();
           }
           else
           {
     ...
     void counterMove()
    {
     ...
     void printStatus()
     {
         int a=Integer.parseInt(pb1.getName());
         int b=Integer.parseInt(pb2.getName());
         int c=Integer.parseInt(cb1.getName());
         int d=Integer.parseInt(cb2.getName());
         
         System.out.println("CPU HANDS "+c+"  "+d);
         System.out.println("User HANDS "+a+"  "+b);
     }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Board_easy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Board_easy().setVisible(true);
            }
        });
    }
