...
% Last Modified by GUIDE v2.5 25-Oct-2013 20:25:01
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
imshow('title.jpg',handles.axes1);
close book_search;
close control_panel;
close csoft_passwordUI;
close csql_passwordUI;
close delete_book;
close issue;
close mysql_password_utility;
close mysql_passwordUI;
close newbook;
close nsoft_passwordUI;
close nsql_passwordUI;
close csoft_passwordUI;
close passwordUI;
close return_book;
close software_password;
close start;
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
sqlpass = mysql_passwordUI();
softpass=soft_passwordUI();
...
if isconnection(conn) % check to make sure that we successfully connected
    ...
    if(strcmp(rsdata,softpass)==1)
       ...
       close LOGIN
        ...
        msgbox('Invalid Software Password ! Please try again !');
        
        
    end
else
       msgbox('Invalid MySQL Password ! Please try again !');
