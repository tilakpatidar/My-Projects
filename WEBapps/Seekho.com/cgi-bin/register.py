...
def hashPassword(key):
	...
	return str(temp)
def updateRecord(fname,lname,email,dob,pswd,sex,username,college):
	...
	try:
		...
		sql1 = "INSERT INTO info (fname, lname, email,dob,sex,username,college) VALUES ('%s', '%s','%s', '%s','%s', '%s','%s')"%(fname,lname,email,dob,sex,username,college)
		# Execute the SQL command
		sql2 = "INSERT INTO auth (username,pswd) VALUES ('%s', '%s')"%(username,pswd)
                                ...
                                <div class="container" style="height:100&percnt;;width:100&percnt;;">
                                    ...
                                    <div class="row" style="height:80&percnt;;width:100&percnt;;">
                                        <div class="center-block" style="height: 80&percnt;;width: 100&percnt;;">
                                            ...
                                            <div>
                                                <label class="label label-primary">Username</label> <input name="username" class="form-control" type="text" placeholder="Username"/>
                                            </div>
                                            <div>
                                                <label class="label label-primary">Password</label> <input name="pswd" class="form-control" type="password" placeholder="Password"/>
                                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="center-block" style="width: 160px;">
                            ...
                            <div class="text-center" style="width: 160px;">
                                &#x00a9; 2014 Seekho.com <br/> All rights reserved.
                            </div>
...
college=str(form.getvalue('college'))
key=str(pswd)
pswd=hashPassword(key)
if updateRecord(fname,lname,email,dob,pswd,sex,username,college):
	printSuccess()
else:
	print "error"
