		...
		<ul class=" nav nav-pills  ">
                            ...
                            <div class="btn-group nav nav-pills" style="width:250px;float: right; ">
                              ...
                              <ul class="dropdown-menu" role="menu">
                                  <li><div style="width: 250px;height: 120px;"><div style="float: left;"><img style="margin-left: 2px;" class="img-thumbnail" src="/images/user.png" width="110" height="110" alt=""></div><div style="float: right;height: 110px;"><label class="label label-primary " style="font-size: medium; margin-right: 7px; " >Tilak Patidar</label><br/><label class="label label-default" style="font-size:xx-small;">1031310537</label></div></div></li>
                 ...
                 <div class="input-group" style="width:35&percnt;; float: left;">
                 
                                <input id="search" style="width: 90&percnt;;"  type="text" autocomplete="off" name="search" class="autocomplete" placeholder="Search our members">              
                                <span style="width: 20px;z-index: 99;" class="input-group-addon glyphicon glyphicon-search"></span>
