...
def letUserGiveAnotherProblem(username,problem):
	try:
		...
		sql2="INSERT INTO problem (username,prblm) VALUES('%s','%s')"%(username,problem)
		cursor2 = db2.cursor()
...
<html>
    ...
    <body  id="body" >
        ...
        <div style="padding-left:50&percnt;padding-top:10&percnt;;" id="middle">
       <label >Dear <strong>%s</strong>,<br> There is already a problem reported by you on:<br><br><br> <strong>%s</strong> <br><br><br> Our whole team is working towards it.<br> Regards,<br> Team SRMSE</label>
