	...
	try:
		...
		if not results is None:
			for val in results:
				...
				break	
				global notify
			webPage(notify,username,fname,lname,sex,dob,year,category,vertical,position,work,skill,ach,email,mob,name,profile_pic,regno)
		else:
			print "invalid username"
...
def webPage(notification,username,fname,lname,sex,dob,year,category,vertical,position,work,skill,ach,email,mob,name,profile_pic,regno):
	print """ <!DOCTYPE html>
<!--
...
<script type="text/javascript" src="/js/jquery-ui.min.js"></script>
		...
		<ul class=" nav nav-pills  ">
                                    ...
                                    <li class="active">
                                      <a href="sendMessage.py">
                                        <span class="badge pull-right">%s</span>
                                        Messages
                                      </a>
                                    </li>
 ...
 """%(notification,profile_pic,name,regno,profile_pic,regno,name,username,fname,lname,sex,dob,year,category,vertical,position,work,skill,ach,email,mob)
