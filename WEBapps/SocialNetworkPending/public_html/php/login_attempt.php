...
<html>
    <head>
        ...
        <meta name="viewport" content="width=device-width">
         ...
         <link type="text/css" href="/css/login_attempt.css" rel="stylesheet"/>
         <script type="text/javascript">
             $(document).ready(function(){
                 document.getElementById("rsn").innerHTML="<?php echo $_GET['reason']; ?>";
                 $("#warning").hide();
...
function containsNum(jqcomp){
 ...
 $(function() {
    ...
    <body  id="body" >
          <div id="warning" class="alert alert-danger" ><strong>Oh Snap !</strong> This website works on JavaScript ! Please enable it !</div> 
        ...
        <form name="login" id="login" action="auth.php" method="POST">
            <label id="warn">Login Attempt Unsuccessful</label><br/>
            Your previous attempt to login failed! Due to
            <label class="label label-danger" id="rsn"></label>
            <br/>
            <div class="form-inline">
                <label id="luname" class=" form-control"> User Name </label>
                <input id="uname" class=" form-control " type="text" name="uname" />
                 
             <br/>
            </div>   
            <div class="form-inline">
            <label id="lpswd" class=" form-control"> Password  </label>
            <input id="pswd" autocomplete="off" onkeypress="capLock(event)" class=" form-control" type="password" name="pswd"/>
            <input type="submit" class=" btn btn-success"  id="submit"  name="submit" value="Log In"/>
            <br/>
            </div>
          <br/>
